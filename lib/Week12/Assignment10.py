...
def ivp_rocket(speed, target):
    ...
    tspan = [0,te]
    [t45, vx45] = solve_ivp(rocket_ode, tspan, vx0, args=(speed, target), events=halt_check)
...
vini = newton(lambda speed: ivp_rocket(speed, xf)[0], vini0)
[res, t45, vx45] = ivp_rocket(vini, xf)
